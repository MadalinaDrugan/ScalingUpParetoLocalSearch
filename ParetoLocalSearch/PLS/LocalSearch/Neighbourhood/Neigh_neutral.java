 ...
 * @author madalina
 */
public class Neigh_neutral implements Neighbours{
   ...
   @Override public ArchiveSolutions neighbours(Solution ps, ArchiveSolutions nda, Variator var, IteratorSolutions iter, Scalarizer scal){
        ...
        while(iter.hasNext()){
            ...
            //best first
            if(s1.dominates(ps,scal) || s1.incomparable(nda,epsilon)){
                nda.add(s1,scal);
                ps.setVisited();
                return nda;
            }
    ...
    @Override public ArchiveSolutions neighboursReduction(Solution ps, ArchiveSolutions nda, Variator var, IteratorSolutions iter, int index){
        ...
        while(iter.hasNext()){
            ...
            if(s1.dominatesReduction(ps,tempWeights) || s1.incomparableReduction(nda,tempWeights)){
   ...
   @Override public ArchiveSolutions neighbours(Solution ps, ArchiveSolutions nda, Variator var, IteratorSolutions iter){
        ...
        while(iter.hasNext()){
            ...
            //best first
            if(s1.dominates(ps) || s1.incomparable(nda,epsilon)){
                nda.add(s1);
                ps.setVisited();
                return nda;
            }
